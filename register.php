                                    ...
                                    <div class="card-body">
                                        <?php 
                                          if (isset($_POST['register'])) {
                                               ...
                                               $insert = mysqli_query($koneksi, "INSERT INTO user(nama,username,password,email,alamat,no_telpon,level) VALUES('$nama','$username','$password','$email','$alamat','$no_telpon','$level')");
                                               if($insert){
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">  &copy; 2024 perpustakaan digital.</div>
                            <div>
